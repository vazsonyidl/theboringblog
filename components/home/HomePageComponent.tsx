  ...
  return (
    <section className={styles.contentContainer}>
      <section className={styles.title}>
        ...
        <h4>How can you profit from this?</h4>
      </section>
      <section>
        ...
        <section className={styles.contentRow}>
          ...
          <article className={styles.content}>
            ...
            <div className={styles.description}>
              ...
              <p>
                By relying on well-tested methods, you can lay back while the
                market is in panic
              </p>
            </div>
          </article>
        ...
        <section className={styles.contentRow}>
          <article className={styles.content}>
            ...
            <div className={styles.description}>
              <h1>Take control</h1>
              <p>
                Have a stressless investment portfolio that makes a stable
                compounding machine
              </p>
            </div>
          </article>
        ...
        <section className={styles.contentRow}>
          ...
          <article className={styles.content}>
            ...
            <div className={styles.description}>
              <h1>Enjoy </h1>
              <p>
                The finish line and confetti may seems a bit far away at the
                beginning, but trust me, you will enyjoy the journey as well as
                the final result
              </p>
            </div>
          </article>
