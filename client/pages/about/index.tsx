    ...
    <main>
      <section role="textbox" className={styles.contentContainer}>
        ...
        <p className={`${styles.limitWidth} ${styles.infoParagraph}`}>
          ...
          These usually emphasise the passive income and long term investments’
          success, but how can people get there? Take tips and trick from the
          community so maybe, after your own research you can start to build
          your own compounding machine!
        </p>
        ...
        <p className={`${styles.limitWidth} ${styles.infoParagraph}`}>
          I really hope that more and more people will be aware that relying on
          the pension system is not a good idea. I can say that with a not so
          huge amount of saved and invested money on a monthly bases people can
          dramatically help their future self’s financial status - enjoying the
        ...
        <p className={`${styles.limitWidth} ${styles.infoParagraph}`}>
          ...
          to have up-to-date knowledge. Cryptocurrencies, NFTs, smart contracts
          are just a few buzz-word going around in the last few year. But this
          blog’s main goal is the traditional, long term dividend investment.
        </p>
      </section>
    </main>
  );
